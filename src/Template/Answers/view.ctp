...
<div class="answers view large-10 medium-9 columns">
    ...
    <div class="row">
        <div class="large-5 columns strings">
            <h6 class="subheader"><?= __('Answer Text') ?></h6>
            <p><?= h($answer->answer_text) ?></p>
            <h6 class="subheader"><?= __('Comment') ?></h6>
            <p><?= $answer->has('comment') ? $this->Html->link($answer->comment->id, ['controller' => 'Comments', 'action' => 'view', $answer->comment->id]) : '' ?></p>
        ...
        <div class="large-2 columns dates end">
            ...
            <p><?= h($answer->created) ?></p>
            <h6 class="subheader"><?= __('Modified') ?></h6>
            <p><?= h($answer->modified) ?></p>
        </div>
    </div>
</div>
