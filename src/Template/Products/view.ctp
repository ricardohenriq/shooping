<?php
	$this->start('meta');
        ...
        echo $this->Html->meta('title',$pageTitle);
    ...
    $this->start('script');
        ...
        echo $this->Html->script('library/elevatezoom/jquery.elevateZoom-3.0.8.min.js',['defer' => true]);
        echo $this->Html->script('library/bxslider-4-4.1.2/jquery.bxslider.min.js',['defer' => true]);
        echo $this->Shrink->js(['actions/main.js', 'actions/view-product.js']);
