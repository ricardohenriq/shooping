<?php
    $this->start('meta');
        ...
        echo $this->Html->meta('title','Loja Produtos');
    ...
    $this->start('css');
        ...
        echo $this->Shrink->css(['styles/style.css', 'styles/hover-images.css', 'styles/upload-products.css']);
    ...
    $this->start('script');
        ...
        echo $this->Shrink->js(['actions/main.js', 'actions/index-banners.js', 'actions/upload-products.js']);
	...
	if($userId == false){
        ...
        $this->start('modals');
			...
			echo $this->element('Modal/add_product_modal');
            echo $this->element('Modal/view_product_modal');
        $this->end();
    }
?>
...
<div class="row">
	...
	<?= $this->element('Body/store_products') ?>
</div>