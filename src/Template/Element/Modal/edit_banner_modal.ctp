<div class="modal fade" id="edit_banner_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title span7 text-center title" id="myModalLabel">Editar Banner #</h4>
            </div>
                ...
                <?= $this->Form->create(null, ['url' => ['controller' => 'Banners', 'action' => 'add'], 'type' => 'file', 'id' => 'add-banner-form', 'class' => 'form-horizontal']) ?>
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <?= $this->Form->input('link', ['label' => false, 'id' => 'link-edit', 'class' => 'form-control']) ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="link" class="control-label col-md-3">Arquivo do Banner</label>
                            <div class="col-md-9">
                                <?= $this->Form->file('banner',['class' => 'form-control', 'id' => 'banner-edit']) ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title" class="control-label col-md-3">Título</label>
                            <div class="col-md-9">
                                <?= $this->Form->input('title', ['label' => false, 'id' => 'title-edit', 'class' => 'form-control']) ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="country" class="control-label col-md-3">Geo Targeting</label>
                            <div class="col-md-9">
                                <?= $this->Form->select('country', ['all' => 'All (WorldWide)'], ['class' => 'form-control country', 'id' => 'country-edit']) ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="show-times" class="control-label col-md-3">Exibir</label>
                            <div class="col-md-3">
                                <?= $this->Form->input('show-times', ['label' => false, 'id' => 'show-times-edit', 'class' => 'form-control']) ?>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <?= $this->Form->input('show-user', ['label' => false, 'id' => 'show-user-edit', 'class' => 'form-control']) ?>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label for="sunday">
                                        <input type="checkbox" name="weekdays[]" id="sunday-edit" value="1">
                                        Domingo
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label for="monday">
                                        <input type="checkbox" name="weekdays[]" id="monday-edit" value="2">
                                        Segunda
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label for="tuesday">
                                        <input type="checkbox" name="weekdays[]" id="tuesday-edit" value="3">
                                        Terça
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="checkbox">
                                    <label for="wednesday">
                                        <input type="checkbox" name="weekdays[]" id="wednesday-edit" value="4">
                                        Quarta
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label for="thursday">
                                        <input type="checkbox" name="weekdays[]" id="thursday-edit" value="5">
                                        Quinta
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label for="friday">
                                        <input type="checkbox" name="weekdays[]" id="friday-edit" value="6">
                                        Sexta
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label for="saturday">
                                        <input type="checkbox" name="weekdays[]" id="saturday-edit" value="7">
                                        Sabado
                                    </label>
                                </div>
                            </div>
