<div class="modal fade" id="view-product-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title span7 text-center" id="myModalLabel">Visualizar Produto</h4>
            </div>
            <div class="modal-body">
                <div class="products-images">
                    <ul class="product-slider">
                        <li><img src="http://localhost/PROJETOS/ShoppingResources/img/19/Espumante-Cava-Freixenet-Carta-Nevada-750ML-1.jpg" class="product-pic"></li>
                        <li><img src="http://localhost/PROJETOS/ShoppingResources/img/19/Espumante-Cava-Freixenet-Carta-Nevada-750ML-2.jpg" class="product-pic"></li>
                        <li><img src="http://localhost/PROJETOS/ShoppingResources/img/19/Espumante-Cava-Freixenet-Carta-Nevada-750ML-3.jpg" class="product-pic"></li>
                        <li><img src="http://localhost/PROJETOS/ShoppingResources/img/19/Espumante-Cava-Freixenet-Carta-Nevada-750ML-4.jpg" class="product-pic"></li>
                    </ul>
                </div>
                    ...
                    <table style="width:100%" class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    Cart├úo Micro SD (N├úo Acompanha)
                                </td>
                            </tr>
                        </tbody>
                    </table>
