...
<html>
    <head>
        ...
        <?= $this->Html->meta('title',__('Mini Mapa de Lojas')) ?>
        ...
        <?= $this->Html->css('library/jquery-jvectormap-2.0.4.css') ?>
        ...
        <?= $this->Html->script('library/jquery-jvectormap-2.0.4.min.js',['defer' => true]) ?>
