<?php
    $this->start('meta');
        ...
        echo $this->Html->meta('title','Mini Mapa de Lojas');
    ...
    $this->start('css');
        ...
        echo $this->Html->css('library/jquery-jvectormap-2.0.4.css');
    ...
    $this->start('script');
        ...
        echo $this->Html->script('library/jquery-jvectormap-2.0.4.min.js',['defer' => true]);
        ...
        $this->Shrink->js(['actions/main.js', 'actions/mall-jvectormap.js', 'actions/mini-map.js']);
