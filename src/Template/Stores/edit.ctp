<?php
	$this->start('meta');
        ...
        echo $this->Html->meta('title','Loja A');
	...
	$this->start('script');
		...
		$this->Shrink->js(['actions/main.js', 'actions/index-banners.js', 'actions/store-edit.js']);
	...
	if($userId == false){
        ...
        $this->start('modals');
            ...
            echo $this->element('Modal/add_store_media_modal');
        $this->end();
    }
?>
