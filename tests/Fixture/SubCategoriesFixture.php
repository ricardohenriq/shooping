...
class SubCategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sub_category_name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'sub_categories_ibfk_1' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'category_id' => 1,
            'created' => '2015-07-17 20:27:07',
            'modified' => '2015-07-17 20:27:07'
        ],
    ];
}
